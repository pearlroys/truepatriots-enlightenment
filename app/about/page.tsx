export default function About() {
    return (
      <main className="max-w-6xl mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        {/* PAGE TITLE */}
        <h1 className="text-4xl md:text-5xl font-bold mb-10 text-[#1F2937]">
          About True Patriots
        </h1>
  
        <p className="text-lg text-gray-700 max-w-4xl leading-relaxed">
          True Patriots Enlightenment and Empowerment Organization (TPEE) is a
          non-governmental, non-profit and strongly non-partisan organization
          devoted to the rebirth of Africa through enlightenment, integrity,
        ...
        <section className="mt-20">
          ...
          <div className="space-y-6 text-gray-700 leading-loose max-w-4xl">
            <p>
              ...
              attributed to Russian President Vladimir Putin, describing Africa
              as a continent where wealthy citizens often return only to be
              buried after living abroad.
            </p>
        ...
        {/* MISSION */}
        <section className="mt-24 bg-white rounded-2xl p-10 md:p-14 shadow-sm">
          <h2 className="text-3xl font-bold text-[#1F6F6B] mb-6">
            Our Mission
          </h2>
          ...
          <div className="space-y-6 text-gray-700 leading-loose max-w-4xl">
            <p>
              True Patriots is a non-governmental, non-religious, non-tribal,
            ...
            <p>
              ...
              engagement across Africa and the diaspora.
            </p>
          </div>
        </section>
        ...
        {/* CORE VALUES */}
        <section className="mt-24 bg-[#FAF7F2] rounded-2xl p-10 md:p-14">
          <h2 className="text-3xl font-bold text-[#1F6F6B] mb-8">
            Our Core Values
          </h2>
  
          <ul className="grid md:grid-cols-2 gap-6 text-gray-700 text-lg">
            <li>• True patriotism and love for Africa</li>
            <li>• Honesty in leadership and daily life</li>
            <li>• Integrity as a non-negotiable value</li>
            <li>• Zero tolerance for corruption</li>
            <li>• Non-religious, non-tribal and non-regional bias</li>
            <li>• Gender equality and color blindness</li>
          </ul>
        </section>
        ...
        <section className="mt-24">
          ...
          <ul className="space-y-4 text-gray-700 text-lg max-w-4xl">
            ...
            <li>• Seminars, symposia and leadership training programs</li>
            <li>• Social media enlightenment campaigns</li>
        ...
        <section className="mt-24 bg-[#FAF7F2] rounded-2xl p-10 md:p-14">
          ...
          <ul className="grid md:grid-cols-2 gap-6 text-gray-700 text-lg">
            <li>• African youths and students</li>
            <li>• Community leaders and professionals</li>
            <li>• Public servants and political office holders</li>
            <li>• Artisans, traders and market associations</li>
            <li>• African diaspora communities</li>
            <li>• Institutions and development partners</li>
          </ul>
        </section>
